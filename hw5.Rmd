...
For the control arm group, there isn't an obvious trend in observation values over time. For the experimental group, there is an increasing trend in observation values as the number of weeks increases. 
